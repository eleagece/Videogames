...
var Game = new function() 
  ...
  this.initialize = function(canvasElementId,sprite_data,callback) 
    // Esta función inicializa el juego. Se le pasa el nombre del canvas del juego (canvasElementId),
    // la información de dónde están los sprites en el .png (sprite_data) y la función que tiene que
    // ejecutar una vez se termine la inicialización (callback)
    {
  ...
  // Handle Input
  var KEY_CODES = { 32 :'enter',37:'left',38:'up', 39:'right', 40 :'down' };
  this.keys = {};
...
// Clase 'Level'
////////////////////////////////////////////////////////////////////////////////////////////////// 
var Level = function(levelData,objFunction,callback) {
  this.levelData = [];
  this.objectFunction =objFunction;
...
Level.prototype.step = function(dt) {
  ...
  while((curShip = this.levelData[idx]) && 
    ...
    //if(this.t > curShip[1]) {
      ...
      this.board.add(new this.objectFunction(enemy,override));
...
var TouchControls = function() {
  ...
  this.draw = function(ctx) {
    ...
    this.drawSquare(ctx,4*unitWidth,yLoc,"A",Game.keys['enter']);
